module PBRibbons
  ...
  def PBRibbons.getDescription(id)
    desc = ["",
       ...
       _INTL("Ribbon for clearing the Jermon League and entering the Hall of Fame in another region. "),
       ...
       _INTL("Jermon Event Participation Ribbon."),
       ...
       _INTL("A Ribbon awarded to a Jermon deemed to have a top-quality footprint."),
       ...
       _INTL("A Ribbon that proclaims love for Jermon."),
       ...
       _INTL("Jermon League Champion Ribbon."),
       _INTL("Battle Competition Champion Ribbon."),
       _INTL("Jermon World Championships Regional Champion Ribbon."),
       _INTL("A Ribbon awarded for winning 100 matches in a row."),
       _INTL("Jermon League Champion Ribbon."),
       _INTL("Jermon World Championships National Champion Ribbon."),
       _INTL("Jermon World Championships World Champion Ribbon.")
    ]
    return desc[id]
  end
end