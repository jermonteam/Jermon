...
class MapScreenScene
  LOCALMAPS = [
     ...
     ["HealingSpot",MapCoordsProperty,
        _INTL("Map ID of this Jermon Center's town, and X and Y coordinates of its entrance within that town.")],
     ...
     ["WildBattleBGM",BGMProperty,
        _INTL("Default BGM for wild Jermon battles on this map.")],
     ["TrainerBattleBGM",BGMProperty,
        _INTL("Default BGM for trainer battles on this map.")],
     ["WildVictoryME",MEProperty,
        _INTL("Default ME played after winning a wild Jermon battle on this map.")],
  ...
  GLOBALMETADATA=[
     ["Home",MapCoordsFacingProperty,
        _INTL("Map ID and X and Y coordinates of where the player goes if no Jermon Center was entered after a loss.")],
     ["WildBattleBGM",BGMProperty,
        _INTL("Default BGM for wild Jermon battles.")],
     ["TrainerBattleBGM",BGMProperty,
        _INTL("Default BGM for Trainer battles.")],
     ["WildVictoryME",MEProperty,
        _INTL("Default ME played after winning a wild Jermon battle.")],
     ["TrainerVictoryME",MEProperty,
